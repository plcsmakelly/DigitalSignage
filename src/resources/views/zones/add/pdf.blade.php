...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6">
    ...
    <form action="{{ url('zones/content/add/pdf/'.$zone->id) }}" method="post" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="mt-5 md:mt-0 md:col-span-2">
	  ...
	  <div>
		...
		<p class="mt-2 text-sm text-gray-500">
			Only PDF files are accepted.<br />The display may scale each page to fit the screen.
              </p>
            </div>
