...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6">
    ...
    <form action="{{ url('zones/content/add/pic/'.$zone->id) }}" method="post" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="mt-5 md:mt-0 md:col-span-2">
	  ...
	  <div>
		...
		<p class="mt-2 text-sm text-gray-500">
			Only PNG files are accepted.<br />Recommended resolution is 1920 px by 1080 px.
              </p>
            </div>
