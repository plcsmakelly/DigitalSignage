...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6">
    ...
    <form action="{{ url('zones/content/add/video/'.$zone->id) }}" method="post" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="mt-5 md:mt-0 md:col-span-2">
	  ...
	  <div>
		...
		<p class="mt-2 text-sm text-gray-500">
			Only MP4 files are accepted.<br />Recommended resolution is 1920 px by 1080 px.<br />Max upload size is 500MB.
              </p>
            </div>
