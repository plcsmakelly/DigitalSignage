...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6">
    ...
    <form action="{{ url('zones/content/add/zone/'.$zone->id) }}" method="post">
    {!! csrf_field() !!}
    <div class="mt-5 md:mt-0 md:col-span-2">
	  ...
	  <div>
		...
		<div class="mt-1">
			<select class="form-select mt-1 block w-full" name="zone">
    ...
    @endforeach
		...
		<p class="mt-2 text-sm text-gray-500">
			Only zones you have access to view are shown in this list.
              </p>
            </div>
